...
/**
 * Page format. Use US Poker Card size (2.5x3.5in) plus 0.25 for the bleed area.
 */
define ('PDF_PAGE_FORMAT', array(69.85, 95.25));
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Kevin Waddell. Made with TCPDF');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Kevin Waddell. Made with TCPDF');

/**
 * Document title.
 */
define ('PDF_TITLE', 'Cards');


/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Cards - Website name\nwww.website.com");
